...
Version  : 3.24.0
Release  : 8
URL      : https://download.gnome.org/sources/gnome-characters/3.24/gnome-characters-3.24.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-characters/3.24/gnome-characters-3.24.0.tar.xz
...
%prep
%setup -q -n gnome-characters-3.24.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1499265477
