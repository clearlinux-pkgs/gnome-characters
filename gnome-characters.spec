...
Source0  : https://download.gnome.org/sources/gnome-characters/3.26/gnome-characters-3.26.1.tar.xz
...
%prep
%setup -q -n gnome-characters-3.26.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1507153278
