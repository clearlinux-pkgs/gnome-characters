...
Version  : 3.20.1
Release  : 1
URL      : https://download.gnome.org/core/3.20/3.20.2/sources/gnome-characters-3.20.1.tar.xz
Source0  : https://download.gnome.org/core/3.20/3.20.2/sources/gnome-characters-3.20.1.tar.xz
...
%prep
%setup -q -n gnome-characters-3.20.1
