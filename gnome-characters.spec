...
Source0  : https://download.gnome.org/sources/gnome-characters/47/gnome-characters-47.0.tar.xz
...
%prep
%setup -q -n gnome-characters-47.0
cd %{_builddir}/gnome-characters-47.0
pushd ..
cp -a gnome-characters-47.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726761564
