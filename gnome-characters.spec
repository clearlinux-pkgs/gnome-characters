...
Source0  : https://download.gnome.org/sources/gnome-characters/41/gnome-characters-41.0.tar.xz
...
%prep
%setup -q -n gnome-characters-41.0
cd %{_builddir}/gnome-characters-41.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632415575
...
cp %{_builddir}/gnome-characters-41.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-characters/915beadc8cf04bf13ad0e1768e9d593f0c3e83a7
cp %{_builddir}/gnome-characters-41.0/COPYINGv2 %{buildroot}/usr/share/package-licenses/gnome-characters/4cc77b90af91e615a64ae04893fdffa7939db84c
