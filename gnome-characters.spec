...
Source0  : https://download.gnome.org/sources/gnome-characters/46/gnome-characters-46.0.tar.xz
...
%prep
%setup -q -n gnome-characters-46.0
cd %{_builddir}/gnome-characters-46.0
pushd ..
cp -a gnome-characters-46.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710891328
