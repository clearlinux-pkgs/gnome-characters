...
Source0  : https://download.gnome.org/sources/gnome-characters/43/gnome-characters-43.1.tar.xz
...
%prep
%setup -q -n gnome-characters-43.1
cd %{_builddir}/gnome-characters-43.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670506909
