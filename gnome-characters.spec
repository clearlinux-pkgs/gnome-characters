...
Source0  : https://download.gnome.org/sources/gnome-characters/3.32/gnome-characters-3.32.0.tar.xz
...
%prep
%setup -q -n gnome-characters-3.32.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1552660704
