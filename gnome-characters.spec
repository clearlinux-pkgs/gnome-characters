...
Version  : 42.0
Release  : 32
URL      : https://download.gnome.org/sources/gnome-characters/42/gnome-characters-42.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-characters/42/gnome-characters-42.0.tar.xz
...
%prep
%setup -q -n gnome-characters-42.0
cd %{_builddir}/gnome-characters-42.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647722906
...
cp %{_builddir}/gnome-characters-42.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-characters/915beadc8cf04bf13ad0e1768e9d593f0c3e83a7
cp %{_builddir}/gnome-characters-42.0/COPYINGv2 %{buildroot}/usr/share/package-licenses/gnome-characters/4cc77b90af91e615a64ae04893fdffa7939db84c
